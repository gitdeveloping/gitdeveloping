...
@section('content')
    ...
    <section class="p-5 section-grey">
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <p>We're dedicated to providing a community led home for development skills.<br/><br/>

                        Whether you're completely new to coding, or a seasoned veteran, we look to challenge and improve
                        your capability.</p>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <p>Tutorials to help learn the fundamentals of programming.</p>
                </div>
                <div class="col">
                    <img class="mx-auto d-block" src="https://via.placeholder.com/150x150" alt="">
